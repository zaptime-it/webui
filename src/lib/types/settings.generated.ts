...
export const settingsFieldMeta: readonly SettingsFieldMeta[] = [
	...
	{ key: 'fontName', kind: 'string', bootOnly: true, minValue: 0, maxValue: 0, defaultBool: false, defaultInt: 0, defaultStr: 'antonio' },
	{ key: 'fullRefreshMin', kind: 'number', bootOnly: false, minValue: 0, maxValue: 1440, defaultBool: false, defaultInt: 60, defaultStr: '' },
	{ key: 'gitReleaseUrl', kind: 'string', bootOnly: false, minValue: 0, maxValue: 0, defaultBool: false, defaultInt: 0, defaultStr: 'https://git.btclock.dev/api/v1/repos/btclock/btclock_v3/releases/latest' },
	{ key: 'hideLeadZero', kind: 'boolean', bootOnly: false, minValue: 0, maxValue: 0, defaultBool: false, defaultInt: 0, defaultStr: '' },
	{ key: 'hostnamePrefix', kind: 'string', bootOnly: true, minValue: 0, maxValue: 0, defaultBool: false, defaultInt: 0, defaultStr: 'btclock' },
	...
	{ key: 'mdnsEnabled', kind: 'boolean', bootOnly: true, minValue: 0, maxValue: 0, defaultBool: true, defaultInt: 0, defaultStr: '' },
	...
	{ key: 'suffixShareDot', kind: 'boolean', bootOnly: false, minValue: 0, maxValue: 0, defaultBool: false, defaultInt: 0, defaultStr: '' },
