...
export const latestReleaseFake = {
	...
	name: '3.3.14',
	body: '',
	url: 'https://git.btclock.dev/api/v1/repos/btclock/btclock_v3/releases/1080',
	html_url: 'https://git.btclock.dev/btclock/btclock_v3/releases/tag/3.3.14',
	tarball_url: 'https://git.btclock.dev/btclock/btclock_v3/archive/3.3.14.tar.gz',
	zipball_url: 'https://git.btclock.dev/btclock/btclock_v3/archive/3.3.14.zip',
	hide_archive_links: false,
	upload_url: 'https://git.btclock.dev/api/v1/repos/btclock/btclock_v3/releases/1080/assets',
	draft: false,
	prerelease: false,
	created_at: '2025-11-26T02:58:50Z',
	published_at: '2025-11-26T02:58:50Z',
	author: {},
	assets: [],
